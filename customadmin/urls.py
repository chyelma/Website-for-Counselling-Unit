...
from .views import admin_login,logout_admin,admin_dashboard,enroll_counsellor,cancel_appointment,patient,counsellor,manageappoinment
urlpatterns = [
    ...
    path('manageappoinment/', manageappoinment, name='manageappoinment'),
